...
func init() {
	...
	f.BoolVar(&backupOptions.DataLess, "data-less", false, "do not scan file data")
	f.BoolVar(&backupOptions.MetaOnly, "meta-only", false, "do not store data")
}
